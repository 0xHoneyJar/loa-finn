...
# Dwebble/Crustle bet (GAMES-012): the PROVEN v4 type-only pilot (719) on the converged
# top-tier Dwebble/Crustle deck (deck.csv). Force v4 explicitly — the agent.py default is v6.
os.environ["CABT_POLICY"] = "v6"
